...
from orders_kernel.config import settings
from orders_kernel.db.engine import Database
from orders_kernel.db.models import Base, IdempotencyRecord, Order
from orders_kernel.resources import container, get_database, get_temporal_service
from orders_kernel.services.temporal import TemporalService
from orders_kernel.shared.ids import order_id_from_key
from orders_kernel.shared.models import (
...
async def admin_reset(
    ...
    # 1. Temporal namespace — terminate open, optionally delete closed.
