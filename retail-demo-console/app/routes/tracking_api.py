...
async def get_batches():
    ...
    for entry in entries:
        ...
        order_ids = [res["order_id"] for res in results if res.get("ok") and res.get("order_id")]
        order_labels = {res["order_id"]: res["label"] for res in results if res.get("ok") and res.get("order_id")}
